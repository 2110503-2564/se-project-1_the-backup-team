        ...
        <div className='flex flex-col items-center py-12'>
          <div className='w-full'>
            <div className='flex relative items-center justify-between gap-4 mb-4 ml-2 w-auto'>
              <h2 className='text-3xl font-semibold'>Featured Spaces</h2>
              <Button size='sm'>
            ...
            <div className='w-full rounded-md border inset-shadow-sm p-6 pb-2'>
              <div className='flex gap-4 overflow-y-scroll pb-4'>
                {spaces.map((space) => (
